...
def get_optimized_code(query: str) -> str:
    ...
    prompt = query
    try:
        optimized_code = prompter.prompt_main(prompt, prompt_name="default_with_context", temperature=0.45)
        response = optimized_code["llm_response"].strip()
